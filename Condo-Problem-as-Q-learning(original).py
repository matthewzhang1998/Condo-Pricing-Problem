...
def single_time_step():
    ...
    Q[temp_state[0], temp_state[1], temp_state[2], temp_state[3], temp_state[4], time, price_index] += alpha * (reward + gamma * argmax - Q_old)
...
book.save("Convergence Results 10 Types Each Real Distribution.xls")        
